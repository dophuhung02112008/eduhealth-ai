...
const HEALBOOK_DATA: HealbookTopic[] = [
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/8/88/Acne_Vulgaris_Wellcome_L0070353.jpg', caption: 'Mụn viêm dạng nặng ở lưng – thường gặp ở nam sinh tuổi dậy thì.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/Child_with_Eczema_%2834034003%29.jpg', caption: 'Viêm da cơ địa: da khô, đỏ, lichen hóa ở vùng khuỷu tay – đặc trưng của eczema.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/8/88/Oman%27s_face_infected_with_impetigo_Wellcome_L0074829_%28cropped%29.jpg', caption: 'Chốc lở: vết loét nông đóng vảy vàng đặc trưng như mật ong ở cẳng chân trẻ em.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/c/c4/Herpes_zoster_chest.png', caption: 'Zona thần kinh: mụn nước tập trung theo dải thần kinh liên sườn, thường một bên thân mình.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Chol_urt_wheals.jpg', caption: 'Mày đay: các sẩn phù màu đỏ hồng, nổi gồ trên da cánh tay, ngứa dữ dội – đặc trưng của urticaria.' }],
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/4/42/Hand_foot_and_mouth_disease_on_child_feet.jpg', caption: 'Bệnh Tay-Chân-Miệng: phỏng nước đặc trưng ở lòng bàn chân và bàn tay trẻ em.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/Varicella.jpg', caption: 'Thủy đậu: mụn nước trong trên nền da đỏ – hình ảnh "giọt sương trên cánh hoa hồng" đặc trưng.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/3/32/Influenza_virus_particle_8430_lores.jpg', caption: 'Virus cúm Influenza – hình ảnh kính hiển vi điện tử.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/3/3c/ConjunctivitisRedEye.jpg', caption: 'Viêm kết mạc: lòng trắng mắt đỏ rực, ghèn/đục nhiều – dễ lây trong trường học.' }],
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Student_Working_on_Assignments_at_Desk.jpg', caption: 'Biểu hiện stress: căng thẳng, mệt mỏi, khó tập trung – rất phổ biến mùa thi.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Hormones_that_control_puberty.jpg/440px-Hormones_that_control_puberty.jpg', caption: 'Thanh thiếu niên tuổi dậy thì – giai đoạn thay đổi mạnh mẽ về thể chất và tâm lý.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/8/80/Cellulitis.jpg', caption: 'Viêm mô tế bào: da sưng đỏ nóng, lan rộng nhanh – cần kháng sinh.' }],
