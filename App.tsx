...
const HEALBOOK_DATA: HealbookTopic[] = [
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/5/5d/Acne_Vulgaris_Wellcome_L0070353.jpg', caption: 'Mụn viêm dạng nặng ở lưng – thường gặp ở nam sinh tuổi dậy thì.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/a/a0/Atopic_dermatitis_child_1.jpg', caption: 'Viêm da cơ địa: trẻ có tổn thương đỏ, khô, ngứa đặc trưng trên da – đây là biểu hiện kinh điển của eczema atopic.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/f/f0/Impetigo_elbow.jpg', caption: 'Chốc lở: vết loét nông đóng vảy vàng đặc trưng như mật ong trên da trẻ em.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/4/4f/Herpes_zoster_back.jpg', caption: 'Zona thần kinh: mụn nước tập trung theo dải thần kinh liên sườn ở lưng – thường một bên thân mình.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Hives2022.jpg/120px-Hives2022.jpg', caption: 'Mày đay: các sẩn phù màu đỏ hồng, nổi gồ trên da, ngứa dữ dội – đặc trưng của urticaria.' }],
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Hand_foot_and_mouth_disease_on_child_feet.jpg', caption: 'Bệnh Tay-Chân-Miệng: phỏng nước đặc trưng ở lòng bàn chân trẻ em.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/f/ff/Varicella_day_5.jpg', caption: 'Thủy đậu: mụn nước trong trên nền da đỏ – hình ảnh "giọt sương trên cánh hoa hồng" đặc trưng.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/8/86/Influenza_virus_research.jpg', caption: 'Virus cúm Influenza – hình ảnh kính hiển vi điện tử.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Conjunctivitis.jpg/120px-Conjunctivitis.jpg', caption: 'Viêm kết mạc: lòng trắng mắt đỏ rực, ghèn/đục nhiều – dễ lây trong trường học.' }],
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/A_student_answering_a_test.jpg/120px-A_student_answering_a_test.jpg', caption: 'Học sinh căng thẳng trong phòng thi – biểu hiện stress học tập rất phổ biến mùa thi.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Early_and_late_maturing_boys_11.5_to_14.6_and_early_and_late_maturing_girls_11.5_to_14.5_yo.png/120px-Early_and_late_maturing_boys_11.5_to_14.6_and_early_and_late_maturing_girls_11.5_to_14.5_yo.png', caption: 'Thanh thiếu niên tuổi dậy thì – sự phát triển thể chất và tâm lý khác nhau giữa các cá nhân.' }],
  ...
  },
  {
    ...
    educationalImages: [{ url: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Cellulitis3.jpg', caption: 'Viêm mô tế bào: da sưng đỏ nóng, lan rộng nhanh – cần kháng sinh.' }],
